...
messages = excel_data['Message'].tolist()[:3]
print(contacts)
print(messages)
...
options.add_argument(
    "user-data-dir=C:\\Users\\rahi\\AppData\\Local\\Google\\Chrome\\User Data\\")  # Path to your chrome profile
driver = webdriver.Chrome(executable_path="C:\dev\chromedriver", options=options)
